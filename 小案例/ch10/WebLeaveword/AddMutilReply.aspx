<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddMutilReply.aspx.cs" Inherits="AddMutilReply" %>
...
<body>
    ...
    <table class="GbText" style="BORDER-COLLAPSE: collapse; border-right: #ccccff thin solid; border-top: #ccccff thin solid; border-left: #ccccff thin solid; border-bottom: #ccccff thin solid;" borderColor="#93bee2" cellSpacing="0"
		...
		<tr>
			<td colspan="2"><font class="HeaderText">回复多条留言</font></td>
		</tr>
		<tr>
		...
		<tr style="line-height:2;" valign="top">
			...
			<td>
				<asp:ListBox ID="LeavewordList" runat="server" Enabled="False" Height="100px" Width="300px">
				</asp:ListBox></td>
		</tr>		
