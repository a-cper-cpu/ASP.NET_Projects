...
<HEAD>
	<title>第13章：网络在线投票系统===用户登录</title>
			...
			<tr valign="top">
				<td height="270" align="center">
					<table border="0" cellpadding="1" cellspacing="0" width="420">
						<tr>
							<td align="center" height="60" valign="middle" colspan="2"><font class="HeaderText">管理员登录 &nbsp; &nbsp; &nbsp;&nbsp;
								<br></font>
							</td>
						</tr>
						<tr>
					...
					<table border="0" cellpadding="1" cellspacing="0" width="420">
						<tr>
							...
							<td width="80">
								<asp:Button ID="GuestBtn" runat="server" CssClass="ButtonCss" Text="游客，我要投票！" CausesValidation="False" OnClick="GuestBtn_Click" />&nbsp;</td>
						</tr>
						<tr>
