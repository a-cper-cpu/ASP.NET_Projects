<%@ Page language="c#" Codebehind="default.aspx.cs" AutoEventWireup="false" Inherits="client.WebForm1" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="HEIGHT: 251px" cellSpacing="0" cellPadding="0" width="96%" align="center"
				border="0">
				<TR>
					<TD style="HEIGHT: 40px" bgColor="#cccccc">
						<P align="center"><FONT face="宋体" size="6"><STRONG>客户管理系统</STRONG></FONT></P>
					</TD>
				</TR>
				<TR>
