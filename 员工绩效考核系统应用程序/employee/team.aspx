				...
				<TR>
					<TD style="HEIGHT: 176px" vAlign="top" align="center">
						<asp:datagrid id="Dgd_user" runat="server" DataKeyField="team_id" OnUpdateCommand="DataGrid_update"
							...
							<Columns>
								<asp:BoundColumn DataField="team_id" HeaderText="项目编号"></asp:BoundColumn>
								<asp:BoundColumn DataField="team_name" HeaderText="项目名称"></asp:BoundColumn>
						...
						<br>
						</FONT><A href="teamEdit.aspx">添加项目信息</A></FONT></FONT></TD>
				</TR>
				<TR>
